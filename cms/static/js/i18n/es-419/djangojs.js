...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Please follow the instructions here to upload a file elsewhere and link to it: {maxFileSizeRedirectUrl}": "Por favor sigue las instrucciones aqu\u00ed para cargar un archivo en otro lugar y enl\u00e1zalo: {maxFileSizeRedirectUrl}",
