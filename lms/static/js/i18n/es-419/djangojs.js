...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Once in position, use the Take Photo button {icon} to capture your ID": "Una vez en posici\u00f3n, use el bot\u00f3n Tomar foto {icon} para captura su documento de identidad",
    ...
    "You need a valid ID that contains your full name and photo.": "Necesita un documento de indentidad v\u00e1lido que contenga su nombre completo y foto.",
