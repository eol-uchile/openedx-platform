...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "A driver's license, passport, or other government-issued ID with your name and photo": "Una licencia de conducir, pasaporte, c\u00e9dula u otra identificaci\u00f3n oficial con tu nombre y foto",
    ...
    "Add your first content group": "Agrega tu primer grupo de contenido",
    ...
    "An email has been sent to {userEmail} with a link for you to activate your account.": "Se ha enviado un correo electr\u00f3nico a {userEmail} con un enlace para que actives tu cuenta.",
    "An error has occurred. Check your Internet connection and try again.": "Ha ocurrido un error. Revisa tu conexi\u00f3n a Internet e intenta nuevamente.",
    ...
    "Please follow the instructions here to upload a file elsewhere and link to it: {maxFileSizeRedirectUrl}": "Por favor sigue las instrucciones para cargar un archivo en otro lugar y enl\u00e1zalo: {maxFileSizeRedirectUrl}",
    ...
    "{paragraphStart}You entered {boldStart}{email}{boldEnd}. If this email address is associated with your {platform_name} account, we will send a message with password recovery instructions to this email address.{paragraphEnd}{paragraphStart}If you do not receive a password reset message after 1 minute, verify that you entered the correct email address, or check your spam folder.{paragraphEnd}{paragraphStart}If you need further assistance, {anchorStart}contact technical support{anchorEnd}.{paragraphEnd}": "{paragraphStart}Has introducido {boldStart}{email}{boldEnd}. Si esta dirección de correo electrónico está asociada a su cuenta de {platform_name}, le enviaremos un mensaje con instrucciones para recuperar la contraseña a esta dirección de correo electrónico.{paragraphEnd}{paragraphStart}Si no recibe un mensaje de restablecimiento de contraseña después de 1 minuto, compruebe que ha introducido la dirección de correo electrónico correcta o revise su carpeta de correo no deseado.{paragraphEnd}{paragraphStart}Si necesita más ayuda, {anchorStart}póngase en contacto con el servicio de asistencia técnica.{anchorEnd}.{paragraphEnd}",
